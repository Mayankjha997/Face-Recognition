...
face_cascade = cv2.CascadeClassifier("C:\\Users\\ASUS\\AppData\\Local\\Programs\\Python\\Python39\\Lib\\site-packages\\cv2\\data\\haarcascade_frontalface_alt.xml")

skip = 0
face_data = []
dataset_path = 'D:\images of face'
